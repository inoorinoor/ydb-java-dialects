...
import tech.ydb.keycloak.testsuite.clientscope.HardcodedClientScopeStorageProviderFactory;

/**
 *
 * @author hmlnarik
 */
public class YdbFederation extends KeycloakModelParameters {

    private final AtomicInteger counter = new AtomicInteger();

    static final Set<Class<? extends Spi>> ALLOWED_SPIS = ImmutableSet.<Class<? extends Spi>>builder()
      .addAll(Ydb.ALLOWED_SPIS)
