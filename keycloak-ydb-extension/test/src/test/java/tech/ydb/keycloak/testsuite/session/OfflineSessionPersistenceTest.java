...
import tech.ydb.keycloak.testsuite.parameters.RemoteYdb;
...
public class OfflineSessionPersistenceTest extends KeycloakModelTest {
    ...
    public void testLazyOfflineUserSessionFetching() {
        assumeTrue("testLazyOfflineUserSessionFetching requires RemoteYdb (use -P remote-ydb)",
                MODEL_PARAMETERS.stream().anyMatch(p -> p instanceof RemoteYdb));
