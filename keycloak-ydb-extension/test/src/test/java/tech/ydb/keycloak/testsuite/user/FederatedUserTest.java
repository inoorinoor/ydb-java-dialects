...
//@RequireProvider(value = UserStorageProvider.class)
...
//        s.getContext().setRealm(realm);
//
//        s.getProvider(UserStorageProvider.class).preRemove(realm);
//
...
//            var userStorageProvider = (UserMapStorage) session.getProvider(UserStorageProvider.class);
//
//            var userModel = userStorageProvider.addUser(realm, "user1");
...
//            var userStorageProvider = (UserMapStorage) session.getProvider(UserStorageProvider.class);
//            var userModel = userStorageProvider.getUserByUsername(realm, "user1");
//            userModel.setSingleAttribute(LDAPConstants.UID, "changed");
//
//            userStorageProvider.upd
//            return null;
//        });
//
